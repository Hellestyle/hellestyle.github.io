...
function applyRegionGrowing() {
    ...
    const segmentedCanvas = document.getElementById('segCanvas');
...
function applyWatershed() {
    ...
    const originalCanvas = document.getElementById('originalCanvas');
    const originalCtx = originalCanvas.getContext('2d');
    const watershedCanvas = document.getElementById('segCanvas');
...
function processKMeans(imageData, K) {
    const kmeansCanvas = document.getElementById('segCanvas');
